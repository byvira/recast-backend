...
━━━ BRAND VOICE — every sentence must pass through this ━━━
{task.brand_context}
{tone_override}{goal_context}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
"""
    ...
    if not result or "content" not in result:
        return AgentResult(agent="repurpose", platform=task.platform, output={}, success=False)

    content_str = result.get("content", "")
    result["word_count"] = len(content_str.split())
    result["char_count"] = len(content_str)

    return AgentResult(agent="repurpose", platform=task.platform, output=result, success=True)